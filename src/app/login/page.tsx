      ...
      <div className="flex w-full md:w-[45%] lg:w-[40%] items-center justify-center p-6 sm:p-8 relative z-10 bg-white dark:bg-zinc-900 shadow-2xl shadow-black/[0.02] border-r border-gray-100 dark:border-zinc-800">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button 
              type="submit" 
              className="w-full h-11 rounded-xl bg-black dark:bg-zinc-100 text-white dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-white hover:shadow-md font-semibold text-[14px] transition-all duration-200 active:scale-[0.99]" 
              disabled={loading}
            >
