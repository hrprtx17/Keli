      ...
      <div className="max-w-7xl mx-auto pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6 order-2 lg:order-1">
            ...
            {/* Card 1: AI Model */}
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800/80 rounded-2xl p-5 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex items-center gap-4 group hover:border-orange-500/20 dark:hover:border-orange-500/10 transition-all duration-300">
               <div className="h-10 w-10 rounded-xl bg-orange-50 dark:bg-orange-950/20 border border-orange-100/50 dark:border-orange-900/20 flex items-center justify-center shrink-0">
               ...
               <div>
                  ...
                  <p className="text-[12px] text-gray-500 dark:text-zinc-400 mt-0.5">Optimized for fast support & responses</p>
               </div>
            </div>

            {/* Card 2: Appearance */}
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800/80 rounded-2xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
               <h3 className="text-[15px] font-bold text-gray-900 dark:text-zinc-100 mb-5 flex items-center gap-2">
                 <Bot className="w-4 h-4 text-orange-500" />
                 Widget Design
               </h3>
               <div className="space-y-5">
                  <div>
                     <label className="text-[12px] font-semibold text-gray-500 dark:text-zinc-400 block mb-1.5 uppercase tracking-wider">Assistant Name</label>
                     <input 
                       type="text" 
                       value={formData.name}
                       onChange={e => setFormData({...formData, name: e.target.value})}
                       className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800/80 rounded-xl px-3.5 py-2.5 text-[13px] text-gray-900 dark:text-zinc-100 focus:bg-white dark:focus:bg-zinc-900 focus:ring-[3px] focus:ring-orange-500/10 focus:border-orange-500 transition-all outline-none"
                     />
                  </div>
                  <div>
                     <label className="text-[12px] font-semibold text-gray-500 dark:text-zinc-400 block mb-1.5 uppercase tracking-wider">Primary Color</label>
                     <div className="flex gap-3">
                        <div className="relative w-11 h-11 rounded-xl border border-zinc-200/80 dark:border-zinc-800/80 overflow-hidden shrink-0 shadow-sm">
                           <input 
                             type="color" 
                        ...
                        <input 
                          ...
                          value={formData.widgetConfig.primaryColor}
                          onChange={e => setFormData({...formData, widgetConfig: {...formData.widgetConfig, primaryColor: e.target.value}})}
                          className="flex-1 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800/80 rounded-xl px-3.5 py-2.5 text-[13px] font-mono text-gray-700 dark:text-zinc-300 focus:bg-white dark:focus:bg-zinc-900 focus:ring-[3px] focus:ring-orange-500/10 focus:border-orange-500 transition-all outline-none"
                        />
                     </div>
                  </div>
                  <div>
                     <label className="text-[12px] font-semibold text-gray-500 dark:text-zinc-400 block mb-1.5 uppercase tracking-wider">Welcome Message</label>
                     <textarea 
                       rows={3}
                       value={formData.widgetConfig.welcomeMessage}
                       onChange={e => setFormData({...formData, widgetConfig: {...formData.widgetConfig, welcomeMessage: e.target.value}})}
                       placeholder="Enter the welcoming chat bubble text..."
                       className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800/80 rounded-xl px-3.5 py-2.5 text-[13px] text-gray-900 dark:text-zinc-100 leading-relaxed focus:bg-white dark:focus:bg-zinc-900 focus:ring-[3px] focus:ring-orange-500/10 focus:border-orange-500 transition-all outline-none resize-none"
                     />
                  </div>
               </div>
            </div>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 flex items-center justify-center bg-[#fcfbfa] dark:bg-zinc-950 rounded-[32px] p-3 sm:p-8 md:p-12 border border-gray-200/50 dark:border-zinc-800/50 shadow-[inset_0_2px_10px_rgba(0,0,0,0.01)] min-h-[500px] sm:min-h-[650px]">
             ...
             >
                {/* Preview Chat Header */}
                <div 
                  className="px-5 py-4 flex items-center justify-between border-b border-gray-100 dark:border-zinc-800 shrink-0 text-white transition-colors duration-500"
